...
<div class="desktop">
    ...
    <div class="avatar-selection-grid">
        ...
        <a href="Avatar1.html">
            <img class="avatar-1 avatar-click" src="Avatar img/character 1.png">
        </a>

        <a href="Avatar2.html">
            <img class="avatar-2 avatar-click" src="Avatar img/character 2.png">
        </a>

        <a href="Avatar3.html">
            <img class="avatar-3 avatar-click" src="Avatar img/character 3.png">
        </a>

        <a href="Avatar4.html">
            <img class="avatar-4 avatar-click" src="Avatar img/character 4.png">
        </a>

        <a href="Avatar5.html">
            <img class="avatar-5 avatar-click" src="Avatar img/character 5.png">
        </a>

        <a href="Avatar6.html">
            <img class="avatar-6 avatar-click" src="Avatar img/character 6.png">
        </a>

    </div>

    <a href="index.html">
        <img class="back-bg" src="Avatar img/Rectangle.png">
